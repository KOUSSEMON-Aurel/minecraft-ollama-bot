...
import god_commands from './god_commands.js';

const godCommandsList = Object.values(god_commands);

let suppressNoDomainWarning = true;

const commandList = queryList.concat(actionsList).concat(godCommandsList);
const commandMap = {};
